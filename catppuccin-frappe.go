...
// CatppuccinFrappe a soothing pastel theme for the high-spirited
var CatppuccinFrappe = styles.Register(chroma.MustNewStyle("catppuccin-frappe", chroma.StyleEntries{
