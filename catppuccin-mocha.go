...
// CatppuccinMocha a soothing pastel theme for the high-spirited
var CatppuccinMocha = styles.Register(chroma.MustNewStyle("catppuccin-mocha", chroma.StyleEntries{
	...
	chroma.KeywordType:           ctpMochaFlamingo,
	...
	chroma.NameBuiltin:           "italic " + ctpMochaText,
	...
	chroma.LiteralNumber:         ctpMochaTeal,
