...
// CatppuccinMacchiato a soothing pastel theme for the high-spirited
var CatppuccinMacchiato = styles.Register(chroma.MustNewStyle("catppuccin-macchiato", chroma.StyleEntries{
